...
const UPSELL_COPY: Record<UpsellReason, { title: string; subtext: string }> = {
  "recipe-limit": {
    ...
    subtext:
      "Upgrade to Cutesy Eats Pro to save unlimited recipes, unlock Cook Mode, and get smarter grocery lists that only order what you need.",
  },
  "folder-limit": {
  ...
  general: {
    ...
    subtext: "Save unlimited recipes, unlock Cook Mode, and get smarter grocery lists that only order what you need.",
  },
};
