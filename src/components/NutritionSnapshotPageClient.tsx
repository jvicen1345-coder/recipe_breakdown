              ...
              <div className="grid grid-cols-4 gap-2 text-center">
                {[
                  ...
                  <div key={stat.label} className="flex flex-col gap-0.5 rounded-2xl bg-cream-soft px-2 py-3">
                    ...
                    <span className="text-[10px] font-medium tracking-wide text-dusty-rose uppercase">
                      {stat.label}
                    </span>
                  </div>
                ))}
                ...
                <div className="flex flex-col gap-2">
                  {[
                    ...
                    <div key={macro.label} className="flex items-center gap-3">
                      ...
                      <span className="w-10 shrink-0 text-right text-xs font-semibold text-rose-deep">
                        {macro.pct}%
                      </span>
                    </div>
                  ))}
